...
namespace Store.Service.Services.BasketService
{
    public class BasketService : IBasketService
    {
        ...
        public async Task<CustomerBasketDto> UpdateBasketAsync(CustomerBasketDto basket)
        {
            ...
            var updatedCustomerBasket = await _basketRepository.UpdateBasketAsync(customerBasket);

            var updatedBasket = _mapper.Map<CustomerBasketDto>(updatedCustomerBasket);
